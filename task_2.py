text = "Advertising companies say advertising is necessary and important. It informs people about new products." \
      " Advertising hoardings in the street make our environment colourful. And adverts on TV are often funny. " \
       ...
       "But some consumers argue " \
       "that advertising is a bad thing. They say that advertising is bad for children. " \
       ...
       "So they use children’s ‘pester power’ to sell their products. Finally, consumers say, if there is advertising " \
       "there must be rules." \
       "Some adverts advertise unhealthy things like cigarettes and make people waste their money."
#*
text = text.lower()
print(text.count("s"), text.count("t"))
#*
text = text.lower()
